...
This is an example to demo RTOS basic APIs on Nuvoton's Mbed CE enabled boards.
...
1.  Clone the example and navigate into it
    ```
    $ git clone https://github.com/mbed-nuvoton/NuMaker-mbed-ce-RTOS-basic-example
    $ cd NuMaker-mbed-ce-RTOS-basic-example
...
Flash by drag-n-drop built image `NuMaker-mbed-ce-RTOS-basic-example.bin` or `NuMaker-mbed-ce-RTOS-basic-example.hex` onto **NuMaker-IoT-M467** board

### Verify the result

Press device's reset button to execute, LED1 and LED2 will flash on.
